...
<head>
    ...
    <div class="product">
        <div class="small-product">
            <div class="row">
                <div class="col-3">
                    <img src="images/Set-dong-phuc-nam-JK.png" alt="">
                </div>
                <div class="col-3">
                    <img src="images/Set-2-chiec-gom-ao-blazer.png" alt="">
                </div>
                <div class="col-3">
                    <img src="images/so-mi-cao-cap-style-han-dep-trai.png" alt="">
                </div>
    ...
    <div class="small-product">
        ...
        <div class="row">
            <div class="col-4">
                <img src="images/Ao-bong-ro-gia-2-lop-sinh-vien-dep.png" alt="">
                <h4>Áo bóng rổ sinh viên </h4>
                <p>$250,000 VNĐ</p>
            </div>
            <div class="col-4">
                <img src="images/Ao-tshirt-nam-gia-2-lop-ca-tinh-da-nang-style-hongkong.png" alt="">
                <h4>Áo Tshirt nam cá tính đa năng  </h4>
                <p>$300,000 VNĐ</p>
            </div>
            <div class="col-4">
                <img src="images/Ao-phong-nam-form-rong-style-nhat-phan-quang.png" alt="">
                <h4>Áo phông nam form rộng Style  </h4>
                <p>$300,000 VNĐ</p>
            </div>
            <div class="col-4">
                <img src="images/Ao-blazer-ke-o-xu-huong-han-quoc.png" alt="">
