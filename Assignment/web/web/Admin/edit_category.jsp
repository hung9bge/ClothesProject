    ...
    <body class="skin-black">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <div class="form-add" >
                    <form action="SettingCategoryController?action=editPost&id=${categoryDetail.cate_id}" method="post">
                        Name: <input type="text" name="name" value="${categoryDetail.name}"/>
                        <br> <br>
                        Status: 
                        <select name="status"value="${categoryDetail.status}"> 
                            <option>show</option>       
                            <option>hide</option>       
